...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        /*Setting allFeeds array length before the test begins*/
        beforeEach(function(){
    ...
    describe('The menu', function(){
        ...
        it('changed visibility', function(){
            ...
            //current body class before clicked
            expect(body.attr('class')).toBe(currentClass);

            //current body class after clicked once (supposed to be '')
            menuIcon.click();
            expect(body.attr('class')).toBe('');

            //current body class after clicked twice
            menuIcon.click();
            expect(body.attr('class')).toBe(currentClass);
    ...
    describe("Initial Entries", function(){
         ...
         */
         it('has one or more entries', function(done) {
            var feedList = $('.feed');
            var entryLength= feedList.find('.entry-link').length
    ...
    describe("New Feed Selection", function() {
        var currentContent;
        beforeEach(function(done){
            currentContent = $('.entry .feed').contents();    
            loadFeed(1, function(){
                done();
            });
         });
         ...
         */
         it('changes feed', function(done) {
            var newContent = $('.entry .feed').contents();
